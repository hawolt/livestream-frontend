...
export const durationSummaryEl = document.getElementById("ce-duration-summary") as HTMLElement;
...
export const resultPanelEl = document.getElementById("ce-result-panel") as HTMLElement;
export const resultHeadingEl = document.getElementById("ce-result-heading") as HTMLElement;
export const resultStatusEl = document.getElementById("ce-result-status") as HTMLElement;
export const resultRowEl = document.getElementById("ce-result-row") as HTMLElement;
export const resultLinkEl = document.getElementById("ce-result-link") as HTMLInputElement;
export const resultCopyEl = document.getElementById("ce-result-copy") as HTMLButtonElement;
export const resultOpenEl = document.getElementById("ce-result-open") as HTMLAnchorElement;
export const resultRetryEl = document.getElementById("ce-result-retry") as HTMLButtonElement;
