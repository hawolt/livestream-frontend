...
export function startChat(user: string, emoteTwitchId?: string, onLoginRequested?: () => void): void {
    ...
    userlistCloseEl.addEventListener("click", () => setUserlist(false, { restoreFocus: true }));
    helpBtnEl.addEventListener("click", toggleHelp);
    helpCloseEl.addEventListener("click", () => setHelp(false, { restoreFocus: true }));
    settingsBtnEl.addEventListener("click", toggleSettings);
    settingsCloseEl.addEventListener("click", () => setSettings(false, { restoreFocus: true }));
